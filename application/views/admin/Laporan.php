            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-header" align="center"><h1>
                        SMP Negeri 1 Atap Lombok Seminung <p/>
                        <small>Jl. Lumbok Seminung - Lampung Barat - Lampung 34879</small>
                        </h1>
                        <hr/>
                    ...
                    <div class="box-header" align="right">
                        <h5>Lampung Barat, <?php echo date('d-m-Y ');?></h5>
                        <h5>Mengetahui Kepala Sekolah</h5>
                        <br/>
                        <br/>
                        <br/>
                        <br/>
